...
let motionStep = 3;
// motion distance for ennemies at the begining
let motionStepEnemies = 3;
...
function move(div) {
  motionStepEnemies = motionStepEnemies + 0.0001;
  div.style.left = div.offsetLeft - motionStepEnemies + "px";
  console.log(motionStepEnemies);
  if (div.offsetLeft <= 0){
    div.remove();
  }
